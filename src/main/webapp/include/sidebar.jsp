...
<div class="sidebar">
    <ul class="sidebar-menu">
        ...
        <li class="menu-group">
            ...
            <ul class="submenu">
                <li><a href="<%= contextPath %>/admin/access/stats"
                       class="<%= currentPath.contains("/access/stats") ? "active" : "" %>">접속 통계</a></li>
                <li><a href="<%= contextPath %>/admin/stats/lead-traffic"
                       class="<%= currentPath.contains("/stats/lead-traffic") ? "active" : "" %>">상담 신청 & 유입</a></li>
            </ul>
        </li>
        <% } %>
        ...
        <li class="menu-group">
            ...
            <ul class="submenu">
                <li><a href="<%= contextPath %>/admin/change-password"
                       class="<%= currentPath.contains("/change-password") ? "active" : "" %>">비밀번호 변경</a></li>
            </ul>
        </li>
    </ul>
</div>
