<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="model.Inquiry, java.util.List" %>
        <% String adminName=(String) session.getAttribute("adminName"); String role=(String)
            ...
            .equals(role); @SuppressWarnings("unchecked") List<Inquiry> recentInquiries = (List<Inquiry>)
                request.getAttribute("recentInquiries");
                                                ...
                                                <div class="board-preview-section">
                                                        ...
                                                        <table class="board-table">
                                                            ...
                                                            <tbody>
                                                                <% if (recentInquiries !=null &&
                                                                    !recentInquiries.isEmpty()) { for (Inquiry inq :
                                                                    recentInquiries) { %>
                                                                    <tr>
                                                                        <td>
                                                                            <%= inq.getId() %>
                                                                        ...
                                                                        <td>
                                                                            <a
                                                                                href="<%= request.getContextPath() %>/admin/inquiry/detail?id=<%= inq.getId() %>">
                                                                                <%= inq.getTitle() %>
                                                                            </a>
                                                                            <% if (!inq.isRead()) { %>
                                                                        ...
                                                                        <td>
                                                                            <%= new
                                                                                java.text.SimpleDateFormat("yyyy-MM-dd").format(inq.getCreatedAt())
                                                                                %>
                                                                        </td>
                                                                    </tr>
                                                                    <% } } else { %>
                                                    ...
                                                    <div class="board-preview">
                                                        ...
                                                        <table class="board-table">
                                                            ...
                                                            <tbody>
                                                                <% if (recentSelfDiagnosis !=null &&
                                                                    !recentSelfDiagnosis.isEmpty()) { for (Inquiry inq :
                                                                    recentSelfDiagnosis) { %>
                                                                    <tr>
                                                                        <td>
                                                                            <%= inq.getId() %>
